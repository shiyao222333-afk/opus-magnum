...
-   [清理] 已清 17 条验收测试状态记录（file_state.jsonl）
- [3/5] 炼真 ×3（同输入）…
...
-   选中炼真文件: 01_nigredo_transit1_acc_r2_refined.md（同一份提交 3 次）
-   第1次：已注入 01_nigredo_transit1_acc_r2_refined_acc_r1.md，等待熔知摄入（≤900s，每60s探）…
-   第1次：doc_id=doc_402e73c17d19ea27 已记录字段 -> 05_citrinitas_fields_r1.json
-   第1次：已删除测试数据 doc_id=doc_402e73c17d19ea27
-   第2次：已注入 01_nigredo_transit1_acc_r2_refined_acc_r2.md，等待熔知摄入（≤900s，每60s探）…
-   第2次：doc_id=doc_4639e403aa0091ef 已记录字段 -> 06_citrinitas_fields_r2.json
-   第2次：已删除测试数据 doc_id=doc_4639e403aa0091ef
-   第3次：已注入 01_nigredo_transit1_acc_r2_refined_acc_r3.md，等待熔知摄入（≤900s，每60s探）…
-   第3次：doc_id=doc_0f66c9bd30a23ba3 已记录字段 -> 07_citrinitas_fields_r3.json
-   第3次：已删除测试数据 doc_id=doc_0f66c9bd30a23ba3
